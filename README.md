...
Проект сделан по домашнему заданию: персональный AI-анализатор конкурентов с веб-интерфейсом, Selenium-парсингом, ProxyAPI, историей, desktop-клиентом и документацией.
...
Учебные материалы и локальные файлы (`cursor_.md`, `Konspekt.docx`, `.env`, `history.json`, сборочные артефакты desktop) также исключены из публикации.
